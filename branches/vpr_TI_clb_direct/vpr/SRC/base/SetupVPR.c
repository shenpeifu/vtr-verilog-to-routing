...
/* JR-041212 */
    /* Depends on RoutingArch->num_switch */
    RoutingArch->opin_to_ipin_switch = RoutingArch->num_switch;
    ++RoutingArch->num_switch;
...
/* JR-041212 */
    /* Interconnect switch for connecting opins directly to ipins */
    switch_inf[RoutingArch->opin_to_ipin_switch].buffered = TRUE;
    switch_inf[RoutingArch->opin_to_ipin_switch].R = 0.;
    switch_inf[RoutingArch->opin_to_ipin_switch].Cin = Arch.C_ipin_direct;
    switch_inf[RoutingArch->opin_to_ipin_switch].Cout = 0.;
    switch_inf[RoutingArch->opin_to_ipin_switch].Tdel = Arch.T_ipin_direct;
}
...
/* JR-041212 */
    RoutingArch->num_interconnect_pins = Arch.num_interconnect_pins;
}
