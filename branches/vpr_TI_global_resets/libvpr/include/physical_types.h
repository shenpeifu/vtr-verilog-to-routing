...
/* JR-022412 { PB_PIN_NORMAL = 0, PB_PIN_SEQUENTIAL, PB_PIN_INPAD, PB_PIN_OUTPAD, PB_PIN_TERMINAL, PB_PIN_CLOCK }; */
{ PB_PIN_NORMAL = 0, PB_PIN_SEQUENTIAL, PB_PIN_INPAD, PB_PIN_OUTPAD, PB_PIN_TERMINAL, PB_PIN_CLOCK, PB_PIN_RESET };
...
/* JR-022412 */
	t_pb_graph_pin **reset_pins; /* [0..num_reset_ports-1] [0..num_port_pins-1]*/
...
/* JR-022412 */
	int *num_reset_pins; /* [0..num_reset_ports - 1] */
