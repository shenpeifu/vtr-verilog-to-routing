...
/* JR-041212				if (!is_fringe && !is_wire) */
				if (!is_fringe && !is_wire && num_interconnect_pins == 0)
				{
...
/* JR-041212	    if(ptc_num >= type->num_pins */
	    if(ptc_num >= type->num_pins + type->num_interconnects
