...
boolean try_route(int width_fac, struct s_router_opts router_opts,
		...
		t_timing_inf timing_inf, float **net_slack, float **net_delay, float **net_criticality,
	...
	if (router_opts.router_algorithm == BREADTH_FIRST) {
		...
		success = try_timing_driven_route(router_opts, net_slack, net_delay, net_criticality,
